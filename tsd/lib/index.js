...
var express=require("../../node_modules/keystone/node_modules/express")
var app1=express()
...
module.exports = function(ports,app) {
  ...
  createCache(location, { keyEncoding: 'string', valueEncoding: 'json' }, function(error, cache) {
    ...
    */
    ...
    tcpserver.on('connection', function (socket) {    
	  ...
	  //传入数据库开始
	     var gear = keystone.list('Gear');
 
var newGear = new gear.model({
   key:"dd",
	value:4
});
...
//传入数据库结束
  ...
  server:keystone.app.listen(3003,function(){
  console.log("abc")
  }) 
  //port:3003
  });
